...
const IncomeForm = (props: IIncomeProps) => {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    db.transact(
      tx.income[props.edit === true ? props?.editId : id()].update({
    ...
    toast(
      props.edit ? "Income edited Sucessfully" : "Income added Sucessfully",
    );
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        />
        <Button className="w-full bg-blue-800 hover:bg-blue-600" type="submit">
          Submit
        </Button>
      </form>
    </Form>
